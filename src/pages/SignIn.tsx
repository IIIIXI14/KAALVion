...
const SignInPage = () => {
  return (
    <div className="relative min-h-screen bg-[#0A0E13] text-white overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_80%,rgba(0,229,255,0.12),transparent_55%)]" />
      ...
      >
        <div className="rounded-[28px] border border-white/10 bg-[rgba(10,14,19,0.95)] backdrop-blur-2xl p-8 shadow-[0_25px_70px_rgba(0,0,0,0.65)]">
          <div className="mb-6 text-center">
            <h1 className="text-3xl font-black mb-2 bg-gradient-to-r from-[var(--primary)] to-[#00E5FF] bg-clip-text text-transparent">
              Welcome Back
            </h1>
            <p className="text-white/70 text-sm">Sign in to your KAALVION account</p>
          </div>
            ...
            <SignIn
              appearance={{
                ...
                elements: {
                  ...
                  formButtonPrimary:
                    "bg-[#00FF88] hover:bg-[#00FF88]/90 text-[#0A0E13] font-semibold rounded-xl shadow-[0_10px_30px_rgba(0,255,136,0.35)] transition-all duration-300 hover:scale-105",
                  formFieldInput:
                    "bg-white/5 border-white/20 text-white rounded-xl focus:border-[#00FF88] focus:ring-2 focus:ring-[#00FF88]/20",
                  formFieldLabel: "text-white/80 font-medium",
                  formFieldInputShowPasswordButton: "text-white/60 hover:text-[#00FF88]",
                  footerActionLink: "text-[#00FF88] hover:text-[#00FF88]/80 font-semibold transition-colors",
                  identityPreviewText: "text-white",
                  identityPreviewEditButton: "text-[#00FF88] hover:text-[#00FF88]/80",
                  dividerLine: "bg-white/10",
                  dividerText: "text-white/60",
                  formResendCodeLink: "text-[#00FF88] hover:text-[#00FF88]/80",
                  otpCodeFieldInput: "bg-white/5 border-white/20 text-white rounded-xl focus:border-[#00FF88] focus:ring-2 focus:ring-[#00FF88]/20",
