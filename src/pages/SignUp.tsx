          ...
          <div className="relative z-10">
            ...
            >
              ...
              <p className="text-white/70 text-sm sm:text-base">
                Join KAALVION and start building with patented systems
              </p>
            </motion.div>
                ...
                appearance={{
                  ...
                  elements: {
                    ...
                    socialButtonsBlockButton:
                      "bg-transparent border border-white/25 text-white hover:bg-white/10 hover:border-[rgba(236,68,59,0.6)] transition-all duration-300 rounded-full h-12 font-medium text-sm flex-1 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(236,68,59,0.3)]",
                    socialButtonsBlockButtonText: "hidden",
                    socialButtonsBlockButtonArrow: "hidden",
                    socialButtonsBlockButtonIcon: "w-6 h-6 mx-auto",
                    socialButtonsBlock: "flex gap-2 mb-4",
                    formButtonPrimary:
                      "bg-[#ec443b] border border-[rgba(236,68,59,0.65)] hover:bg-[#ec443b]/90 text-white font-semibold rounded-full shadow-[0_12px_35px_rgba(236,68,59,0.55)] transition-all duration-300 hover:-translate-y-1 hover:brightness-110 hover:shadow-[0_16px_45px_rgba(255,111,100,0.62)] h-12 px-8 text-sm w-full flex items-center justify-center gap-2",
                    formButtonPrimaryArrow: "inline-block ml-1",
                    formFieldInput:
                    ...
                    formFieldOptional: "text-white/50 text-xs ml-1 italic",
                    formFieldSuccessText: "text-green-400 text-xs",
                    formFieldErrorText: "text-red-400 text-xs mt-1.5",
                    selectButton: "bg-white/[0.05] border border-white/15 text-white rounded-xl hover:bg-white/[0.08] hover:border-[rgba(236,68,59,0.5)] h-12 transition-all duration-300",
                    selectSearchInput: "bg-white/[0.05] border border-white/15 text-white rounded-xl focus:border-[#ec443b]/80 focus:ring-2 focus:ring-[#ec443b]/50",
                  },
                }}
                routing="path"
                path="/sign-up"
