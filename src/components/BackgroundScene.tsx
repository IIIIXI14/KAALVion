...
const BackgroundScene = () => {
  return (
    <div className="fixed left-28 right-0 top-28 bottom-0 z-0 overflow-hidden pointer-events-none">
      <div className="absolute inset-0 bg-[#02040A] opacity-15" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_10%,_rgba(236,68,59,0.14),_transparent_55%)]" />
